...
describe "Brocade Device" do
  ...
  # cisco = Puppet::Util::NetworkDevice::Cisco_ios::Device.new('ssh://96cc073a43df48098b6b4cae9366c677:7d211471517adf2821bd88ced8e8d378@localhost:22/?enable=enable_password&crypt=true')
  # cisco.crypt == true
  # end
  #
