...
require 'puppet/util/network_device/transport_fos/base_ios'


class Puppet::Util::NetworkDevice::Transport_fos::Ssh < Puppet::Util::NetworkDevice::Transport_fos::Base_ios
