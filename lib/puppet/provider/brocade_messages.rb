module Puppet::Provider::Brocade_messages
  ...
  CONFIG_DOES_NOT_EXIST_INFO="Config %s does not exists"
  ...
  CONFIG_MEMBERSHIP_ADD_INFO="Zone %s need to be added to config %s"
  CONFIG_MEMBERSHIP_REMOVED_INFO="Zone %s need to be removed from config %s"
  ...
  ZONE_MEMBERSHIP_DESTROY_DEBUG="Puppet::Provider::brocade_zone_membership: A zone member with the zonename: %s and  zonemember: %s is being removed from the zone"
  ...
  ALIAS_ALREADY_EXIST_INFO="Alias %s already exist"
  ALIAS_DOES_NOT_EXIST_INFO="Alias %s does not exist"
  ALIAS_CREATE_ERROR="Unable to create alias %s because of the following issue: %s"
  ALIAS_MEMBERSHIP_CREATE_DEBUG="Puppet::Provider::brocade_alias_membership: Adding member WWPN(s) %s to Alias %s."
  ALIAS_MEMBERSHIP_CREATE_ERROR="Unable to add member WWPN %s to alias %s because of the following issue: %s"
  ALIAS_MEMBERSHIP_ALREADY_EXIST_INFO="Member WWPN(s) %s already added to alias %s"
  ALIAS_MEMBERSHIP_DESTROY_DEBUG="Puppet::Provider::brocade_alias_membership: A member WWPN: %s is being removed from the alias: %s"
  ALIAS_MEMBERSHIP_ALREADY_REMOVED_INFO="Member WWPN(s) %s already removed from the alias %s"
  ALIAS_MEMBERSHIP_DESTROY_ERROR="Unable to remove the member WWPN(s) %s from the alias %s Error: %s"
end
